package net.hwyz.iov.mp.app.widget.view
...
fun LoginEditView(
    ...
    BasicLabelEditView(
        ...
        text = text,
        labelText = labelText,
        labelTextColor = AppTheme.colors.primaryText,
        hintText = hintText ?: "",
        onValueChanged = { onValueChanged.invoke(it) },
        deleteIconColor = AppTheme.colors.primaryText,
        onDeleteClick = { onDeleteClick.invoke() },
        inputCursorColor = AppTheme.colors.primaryText,
        inputTextColor = AppTheme.colors.primaryText,
        borderColor = AppTheme.colors.primaryText,
...
private fun BasicLabelEditView(
    ...
    text: String,
    labelText: String,
    labelTextColor: Color = AppTheme.colors.primaryText,
    hintText: String = "",
    deleteIconColor: Color = AppTheme.colors.themeUi,
    onValueChanged: (String) -> Unit,
    onDeleteClick: () -> Unit,
    inputCursorColor: Color = AppTheme.colors.themeUi,
    inputTextColor: Color = AppTheme.colors.primaryText,
    borderColor: Color = AppTheme.colors.secondaryText,
    ...
    TextField(
        ...
        colors = TextFieldDefaults.outlinedTextFieldColors(
            ...
            placeholderColor = AppTheme.colors.secondaryText,
